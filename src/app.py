...
activities = {
    ...
    "Tennis Club": {
        "description": "Practice and compete in tennis matches",
    ...
    "Art Class": {
        ...
        "max_participants": 15,
        "participants": ["olivia@mergington.edu", "john@mergington.edu"]
    },
    "Science Club": {
    ...
    "Drama Club": {
        "description": "Acting, stage production, and theater arts",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 25,
        "participants": ["emma@mergington.edu", "sophia@mergington.edu"]
    },
    "Music Class": {
        "description": "Learn music theory and practice instruments",
